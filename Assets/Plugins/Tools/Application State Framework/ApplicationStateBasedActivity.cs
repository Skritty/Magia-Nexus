...
namespace Skritty.Tools.AppStateSystem {
    ...
    public class ApplicationStateBasedActivity : MonoBehaviour
    {
        ...
        private List<ApplicationState> activeStates = new List<ApplicationState>();
        ...
        private List<ApplicationState> inactiveStates = new List<ApplicationState>();
